...
public class EventAlphabetical extends AppCompatActivity {
        ...
        for (int i = 0; i< eventList.length; i++){
            ...
            register.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(EventAlphabetical.this, "You have signed up. See you then!",
                            Toast.LENGTH_LONG).show();
                    Event temp = new Event(eventList[finalI], locationList[finalI], dateTimeList[finalI],organizationList[finalI]);
                    total.add(temp);
                    Intent minor = new Intent(EventAlphabetical.this, PersonalVoice.class);
