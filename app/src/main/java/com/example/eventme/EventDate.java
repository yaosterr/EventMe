...
public class EventDate extends AppCompatActivity {

    ArrayList<Event> total = new ArrayList<Event>();

    String eventList[] = {"Fire Exhibition", "Elon Musk Talk Show", "Dinner With Lebron James", "Best Friend Party", "Cava Giveaway", "Justin Bieber Meet and Greet", "Nut Party",  "Adele Birthday Party", "Harvard How-tos", "Nice Greetings", "Temper Control", "Physics Class", "Life of Pi Reading", "Christmas Celebration", "Casper Party", "Self Defense Class", "Bill Nye Exhibition", "Love Yourself Readings", "Standup Comedy", "Kevin Hart Party"};
    ...
    String dateTimeList[] = {"7:00PM, 10/06/2022", "7:00PM, 10/06/2022", "9:30PM, 11/01/2022", "9:30PM, 11/01/2022", "9:10PM, 11/03/2022", "9:10PM, 11/03/2022", "11:00PM, 11/15/2022", "11:00PM, 11/15/2022", "10:00AM, 11/20/2022", "10:00AM, 11/20/2022", "7:30PM, 11/20/2022", "7:30PM, 11/20/2022", "9:30PM, 11/20/2022", "9:30PM, 11/20/2022", "10:30PM, 11/20/2022", "10:30PM, 11/20/2022", "7:15AM, 12/02/2022", "9:35PM, 12/20/2022", "7:15AM, 12/02/2022", "9:35PM, 12/20/2022"};
        ...
        for (int i = 0; i< eventList.length; i++){
            ...
            register.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(EventDate.this, "You have signed up. See you then!",
                            Toast.LENGTH_LONG).show();
                    Event temp = new Event(eventList[finalI], locationList[finalI], dateTimeList[finalI],organizationList[finalI]);
                    total.add(temp);
                    Intent minor = new Intent(EventDate.this, PersonalVoice.class);
