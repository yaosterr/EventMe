...
public class EventDistanceGuest extends AppCompatActivity {

    ArrayList<Event> total = new ArrayList<Event>();

    String eventList[] = {"Best Friend Party", "Nice Greetings", "Christmas Celebration", "Physics Class", "Self Defense Class", "Nut Party", "Cava Giveaway", "Adele Birthday Party", "Harvard How-tos", "Love Yourself Readings", "Elon Musk Talk Show",  "Dinner With Lebron James", "Life of Pi Reading", "Temper Control", "Justin Bieber Meet and Greet", "Casper Party", "Standup Comedy", "Kevin Hart Party", "Bill Nye Exhibition", "Fire Exhibition"};
        ...
        for (int i = 0; i< eventList.length; i++){
            ...
            /*register.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(EventDistance.this, "You have signed up. See you then!",
                            Toast.LENGTH_LONG).show();
                    Event temp = new Event(eventList[finalI], locationList[finalI], dateTimeList[finalI],organizationList[finalI]);
                    total.add(temp);
                    Intent minor = new Intent(EventDistance.this, PersonalVoice.class);
