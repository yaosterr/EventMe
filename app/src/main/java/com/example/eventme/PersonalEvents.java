...
public class PersonalEvents extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.d("clicked", "newregister");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.personal_events);
        ...
        if (tempEvent != null){
            for (int i = 0; i< tempEvent.size(); i++) {
                ...
                LinearLayout layout = (LinearLayout) findViewById(R.id.personallayout);
